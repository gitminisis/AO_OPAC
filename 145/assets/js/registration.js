    ...
    $(".next").click(function() {
        ...
        if (index === 0) {
            ...
            if (street.value.trim() === '') {
                showMessage("Veuillez saisir une adresse.")
            } else if (city.value.trim() === '') {
                showMessage("Veuillez saisir une ville.")
            } else if (prov.value.trim() === '') {
                showMessage("Veuillez saisir une province.")
            } else if (postal.value.trim() === '') {
                showMessage("Veuillez saisir un code postal.")
            } else if ((country.value.trim() === '')) {
                showMessage("Veuillez saisir un pays.")
            } else {
                current_fs = $(this).parent();
                next_fs = $(this).parent().next();
                nextForm();
