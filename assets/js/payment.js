...
const requestOrder = () => {
    ...
    let myData = {
        ...
        "success_url": `https://aimsarchives.gov.on.ca/scripts/mwimain.dll/144/PAYMENT_VIEW/WEB_PAY_RCPT_DET/REQ_ORDER_NUM ${merchantNum}?COMMANDSEARCH&sess=${sessionId}`,
        "cancel_url": `https://aimsarchives.gov.on.ca/scripts/mwimain.dll/144/PAYMENT_VIEW/WEB_PAY_CANCEL_DET/REQ_ORDER_NUM ${merchantNum}?COMMANDSEARCH&sess=${sessionId}`,
        "locale": "en",
        testLevel: 1
    }
...
const backToProfile = () => {
    ...
    window.location = `https://aimsarchives.gov.on.ca/scripts/mwimain.dll/${sess}?GET&FILE=[AO_ASSETS]html/patronProfile.html`
}
...
const successRedirectToProfile = async(orderNum) => {
    let url = `https://aimsarchives.gov.on.ca/scripts/mwimain.dll/144/PAYMENT_VIEW/WEB_PAY_RCPT_FINAL/REQ_ORDER_NUM ${orderNum}?COMMANDSEARCH&sess=${sessionId}`
