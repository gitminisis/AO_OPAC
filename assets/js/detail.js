...
const copyPermalink = (e, rep) => {
  let exp = e.value
  let params = rep == 'desc' ? 'DESCRIPTION_WEB/WEB_DESC_DET?SESSIONSEARCH&exp=sisn%20' : rep == 'biblio'? 'BIBLIO_WEB/WEB_BIBLIO_DET?SESSIONSEARCH&exp=sisn%20' : rep == 'people' ? 'PEOPLE_VAL/WEB_PEOPLE_DET_OPAC?SESSIONSEARCH&exp=PERSON_ID%20' : 'ORGANIZATION_VAL/WEB_ORG_DET_OPAC?SESSIONSEARCH&exp=ORG_ID%20'
