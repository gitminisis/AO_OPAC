...
$(document).ready(function () {
    if (document.getElementById('confirmationPage')) {
        ...
        body += "<br /><If you did not create an account, please ignore this email.  Or, you can contact the Archives.  Your call  will be answered by the third ring, and you will have the option of reaching a person. Your call will not be redirected more than once. All calls will be returned within one working day. 1-800-668-9933 Toll-Free Number (Ontario only) or direct dial, 1-416-327-1600 .</strong>"
