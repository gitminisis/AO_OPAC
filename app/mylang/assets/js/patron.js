    ...
    $("button.colorbox-edit-client").click(function(e) {
        ...
        $.ajax(url).done(function(res) {
            ...
            $.colorbox({
                ...
                onCleanup: function() {
                    // alert(saveButtonPressed)
                    iframe.removeEventListener("unload", () => {
...
// handle closure of the edit patron form
const closeWindow = () => {
    if (saveButtonPressed == 1) 
    {
        // if save is pressed, record is already processed
        saveButtonPressedd = 0;
    }
    // unlock the record
    else {
        // SKIPRECORD GOES HERE
    }
}
